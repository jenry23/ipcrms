				...
				<div class="col-md-12">
					...
					<div class="card" style="width: 90vw">
								...
								<form @submit.prevent="submitForm">
									<div class="card-body">
										...
										<table class="table table-border two-table">
											<thead>
												<tr>
													<th class="ipcr-font-size" rowspan="2" colspan="1">
											...
											<tbody>
												<template v-for="ipcrFunction in templates.ipcr_function">
													...
													<template
														v-for="ipcrSubfunction in ipcrFunction.ipcr_subfunctions"
													>
														<tr>
															<td colspan="10">{{ ipcrSubfunction.name }}</td>
														</tr>
														<template
															v-for="performance in ipcrSubfunction.ipcr_performance"
														>
															<tr>
						...
						<facultytemplate :templates="json" :signatures="signatures">
							<template>
								<input type="file" ref="fileInput" style="display: none" @change="handleFileUpload" />
								<button class="btn btn-sm btn-primary ml-5" @click.prevent="openFileInput">
									Upload Signature
								</button>
							</template>
						</facultytemplate>
